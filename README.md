...
* Click on **Code** button (green color)
* Select **Download ZIP**
* Extract the ZIP file

👉 Open terminal / cmd in the extracted folder
OR
👉 Open folder in VS Code (Safe) → Right click on `app.py` → **Open in Integrated Terminal**
...
👉 After activation, you will see `(venv)` at the beginning of your terminal
...
## ▶️ Step 7: Start the Flask Application
